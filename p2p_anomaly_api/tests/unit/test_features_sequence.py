"""
Unit tests for event-level sequence features (features/sequence_features.py),
which feed the LSTM autoencoder. Pure-Python, no artifacts, no DB.
"""
...
def _df():
    # Mon 2024-01-01 10:00 (business hours) and Sat 2024-01-06 23:00 (off hours).
    return pd.DataFrame(
        {
            "case_id": ["c1", "c1"],
...
def test_off_hours_flag_business_vs_weekend_night():
    ...
    # Row 0: Monday 10:00 → on hours. Row 1: Saturday 23:00 → off hours.
