"""
Unit tests for the CSV ingester (ingestion/csv_ingester.py).

These are DB-free and fast. They pin the canonical-schema contract the rest of
the pipeline relies on: mandatory-column validation, alias mapping, timestamp
parsing, numeric coercion and vendor synchronisation.
"""
...
def test_minimal_csv_fills_canonical_columns():
    ...
    # Every canonical column must exist after ingestion.
